...
root = Tk()
root.title("Absensi Perkuliahan Sekolah Vokasi IPB")
...
judul = Label(frameJudul, bg='white', text='Absensi Perkuliahan SV IPB', font=styling)
judul.place(relheight=1,relwidth=1)


frameMatkul = Frame(root, bg='white')
frameMatkul.place(rely=0.15,relx=0.5,relheight=0.06,relwidth=0.8,anchor='n')
...
frameNIM.place(rely=0.36,relx=0.5,relheight=0.06,relwidth=0.8,anchor='n')
...
frameJurusan.place(rely=0.43,relx=0.5,relheight=0.06,relwidth=0.8,anchor='n')
...
frameKelas.place(rely=0.50,relx=0.5,relheight=0.06,relwidth=0.8,anchor='n')
...
informasi.place(rely=0.57,relx=0.5,relheight=0.1,relwidth=0.8,anchor='n')

frameButton = Frame(root, bg='white')
frameButton.place(rely=0.68,relx=0.5,relheight=0.3,relwidth=0.3,anchor='n')
